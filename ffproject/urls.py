...
urlpatterns = [
    ...
    path('register/success/', users_view.SiteRegisterViewSuccess.as_view(),
         name='register_success'),
    path('logout/', users_view.SiteLogoutView.as_view(), name='logout'),

    path('user/newpost/', feed_view.create_post, name='create_post'),
    path('allpost/', feed_view.PostListView.as_view(), name='show_post'),
    path('user/post/', feed_view.show_user_post, name='show_user_post'),
]
